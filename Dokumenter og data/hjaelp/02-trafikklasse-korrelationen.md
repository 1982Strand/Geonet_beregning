...
resume: Hvad Eₒ-matricen på korrelationssiden viser, hvad zonerne under og over betyder, og hvad der sker, når en kørsel rettes.
---
...
- **under** — Den krævede tykkelse af de ubundne lag bestemt i VejDim er tyndere end designdiagrammets tyndeste kurve
  ...
  Eₒ = 30 MPa ligger på 900 mm. I dette tilfælde anses dimensioneringen i Trafikklasse som ugyldig.
- **over** — Den krævede tykkelse af de ubundne lag bestemt i VejDim er tykkere end diagrammets tykkeste kurve
  ...
  for Eₒ = 150 MPa slutter ved 1.100 mm. Her anses dimensioneringen i Trafikklasse også for ugyldig.
